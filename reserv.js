...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (isEditMode) {
        const reservationToEdit = JSON.parse(localStorage.getItem('reservationToEdit') || '{}');
        if (reservationToEdit) {
            document.getElementById('full-name').value = reservationToEdit.guestName || '';
            document.getElementById('email').value = reservationToEdit.email || '';
            document.getElementById('activity').value = reservationToEdit.activity || '';
            document.getElementById('checkin').value = reservationToEdit.checkIn || '';
            document.getElementById('checkout').value = reservationToEdit.checkOut || '';
            document.getElementById('durationType').value = reservationToEdit.durationType || 'days';
            if (reservationToEdit.durationType === 'hours') {
                document.getElementById('durationHours').value = reservationToEdit.durationValue || '';
                document.getElementById('durationHoursGroup').classList.remove('hidden');
                document.getElementById('durationDaysGroup').classList.add('hidden');
            } else {
                document.getElementById('durationDays').value = reservationToEdit.durationValue || '';
                document.getElementById('durationDaysGroup').classList.remove('hidden');
                document.getElementById('durationHoursGroup').classList.add('hidden');
            }
            document.getElementById('paymentMethod').value = reservationToEdit.paymentMethod || '';
            if (reservationToEdit.paymentMethod === 'credit' || reservationToEdit.paymentMethod === 'debit') {
                document.getElementById('cardNumber').value = reservationToEdit.cardNumber || '';
                document.getElementById('cardNumberGroup').classList.remove('hidden');
            }
        }
    }
    ...
    form.addEventListener("submit", async function(e) {
        ...
        window.location.href = 'mesreservationG.html';
    });
